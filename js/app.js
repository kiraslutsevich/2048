...
const getCurrentDataCells = (key = 'matrix') => {
  return currentDataCells = JSON.parse(localStorage.getItem(key))
}
if (localStorage.getItem('matrix')) {
  getCurrentDataCells()
}

const savePrevDataCells = (prevDataCells) => {
  return localStorage.setItem('prevMatrix', JSON.stringify(prevDataCells))
}
const getPrevDataCells = (key = 'prevMatrix') => {
  return prevDataCells = JSON.parse(localStorage.getItem(key))
}
...
const rulesText = document.querySelector('.info');
